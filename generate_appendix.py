...
videos = [
    ...
    # danmaku counts = actual collected (8104), NOT B站 API total (will grow over time)
    ['1', 'BV1Mpd5BFEk1',
     'Upspeed盛嘉成 /\nUpspeed Шэн Цзячэн',
    ...
    ['4', 'BV1ojfDBSEPv',
     ...
     'Технологии', '2026-02-03\n23:37', '82,3万', '1800', '998'],
    ['5', 'BV1SvZyBJENz',
     '山茶爱讲话 /\nШаньча говорит',
     '作为人类,有点看不懂了？\n【2026春晚乐子杂谈】 /\nНепонятно как человеку?\n[Гала-концерт 2026]',
     'Развлечения', '2026-02-17\n19:37', '111,9万', '1161', '1007'],
    ['6', 'BV1xi6kBFEmZ',
     '山茶爱讲话 /\nШаньча говорит',
     '顶级公关？是把人当傻子吧！ /\nВысший пиар? За дураков\nнас держат?',
     'Развлечения', '2026-01-31\n09:43', '120,3万', '1153', '1069'],
]

# Recalculate totals
total_views = '535,4万'
total_raw = sum(int(v[7]) for v in videos)   # 948+2145+897+1800+1161+1153 = 8104
total_cleaned = sum(int(v[8]) for v in videos)  # 459+2100+681+998+1007+1069 = 6314
